  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <DisclosureButton className="fixed z-40 flex items-center justify-center transition duration-300 bg-purple-950 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-indigo-600 focus:bg-indigo-600 ease">
            ...
            >
              <DisclosurePanel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-purple-950">
                ...
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <input
                        type="hidden"
                        value={`${userName} sent a message from NorthSolution`}
                        {...register("subject")}
                      />
                      <input
                        type="hidden"
                        value="North Solution"
                        {...register("from_name")}
                      />
                      <input
                        type="checkbox"
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-purple-950 rounded-md focus:bg-purple-900 focus:outline-none"
                        >
                          {isSubmitting ? (
                            <svg
                      ...
                      >
                        <span>
                          Operated by{" "}
                          <a
                            href="https://discord.gg/the-north-solution-1032785824686817291"
